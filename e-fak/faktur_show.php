...
<!-- CONTENT -->
        ...
        <div class="panel-heading">FAKTUR PAJAK KELUARAN&nbsp;&nbsp;<a class="paging" href="?r=faktur_entry&halaman=<?=$_GET['halaman']?>">NEW</a></div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table table-hover">
  <tr>
    ...
    <td width="15%" align="center"><strong>PEMBELI BARANG/JASA KENA PAJAK</strong></td>
	...
	<td width="8%" align="center"><strong>PPh Final 2%</strong></td>
	<td width="8%" align="center"><strong>DIVISI</strong></td>
	<td width="13%" align="center"><strong>STATUS</strong></td>
    <td width="16%" align="center"><strong>ACT</strong></td>
    </tr>
	<?php
	$batas=15;
	...
	session_start();
	$tampil =mysql_query("SELECT faktur.id_lw,faktur.tanggal,faktur.kode,faktur.no_fak,faktur.keterangan,faktur.nominal,faktur.divisi,faktur.npwp,faktur.id_faktur,faktur.status,
	...
	<td width="8%" align="right"><?php $pphpasal4=number_format($pphpasal4,0,",",",");?><? echo $pphpasal4 ?></td>
    ...
    <td align="left">
    <a href="?r=faktur_edit&id_faktur=<?=$data['id_faktur']?>&halaman=<?=$_GET['halaman']?>"><img src="images/b_edit.png" width="16" height="16" title="Edit data" /></a>
    <a href="?r=arsip_entry&id_faktur=<?=$data['id_faktur']?>"><img src="images/b_home.png" width="16" height="16" title="Arsipkan" /></a>
    <a href="faktur_print.php?id_faktur=<?=$data['id_faktur']?>" target="_blank"><img src="images/b_print.png" width="16" height="16"/></a>
	</td>
  </tr>
    <?php }?>
  <tr>
